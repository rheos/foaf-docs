...
- **Alignment**: Focus on resilience, inclusion, and decentralization (see [overview](../about/overview.md)).
...
- Explore [tokenomics](../about/tokenomics.md) for FOAF/RHEO details.
...
Explore more in [fee-structure](../about/fee-structure.md) and [growoperative pitch](../growoperative/pitch.md).
